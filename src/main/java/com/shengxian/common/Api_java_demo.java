...
public class Api_java_demo {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //提示：打印机编号(必填) # 打印机识别码(必填) # 备注名称(选填) # 流量卡号码(选填)，多台打印机请换行（\n）添加新打印机信息，每次最多100行(台)。
			//String snlist = "817006805#4ywh2jhy#测试2#''";
			//String method = addprinter(snlist);
			//System.out.println(method);


            //String s ="123456789#qw3rtyui \uff08\u9519\u8bef\uff1a\u4e00\u53f0\u6253\u5370\u673a\u6700\u591a\u53ea\u80fd\u7ed1\u5b9a 3 \u4e2a\u8d26\u6237\u3002\uff09";
        //byte[] bytes = s.getBytes();
        //String test= "" ;
        //test = new String(bytes ,"UTF-8");
        //System.out.println(test);

        String t = printerEdit("817006805", "飞蛾1");
...
//			System.out.println(method3);
    ...
    private static String print(String sn){
        ...
        content += "饭　　　　　　 1.0         1" +
                    "1.0元<BR>";
        content += "炒饭　　　　　 100       10000" +
                   "100000.0元<BR>";
        content += "蛋炒饭　　　　 1000       10000" +
                   "100000.0元<BR>";
        content += "鸡蛋炒饭　　　 1000       10000" +
                   "100000.0元<BR>";
        content += "番茄蛋炒饭　　 1000       10000" +
                   "100000.0元<BR>";
        content += "西红柿蛋炒饭　 10000       10000" +
                   "100000.0元<BR>";
        content += "西红柿鸡蛋炒饭 10000       10000" +
                   "100000.0元<BR>";
        content += "备注：加辣<BR>";
        content += "--------------------------------<BR>";
        content += "合计：xx.0元<BR>";
     ...
     * @return
     */
    private static String printerEdit(String sn,String name ){
